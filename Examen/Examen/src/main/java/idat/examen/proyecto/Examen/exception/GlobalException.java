...
public class GlobalException {
    ...
    public ResponseEntity<ErrorException> handleException(MethodArgumentNotValidException e, WebRequest webRequest) {
        List<String> listaErrores = e.getBindingResult()
                .getFieldErrors()
                .stream()
